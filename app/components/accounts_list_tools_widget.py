...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.spacerItem = QtWidgets.QSpacerItem(25, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(self.spacerItem)
        self.all_settings_button = ToolButton(Form)
        self.all_settings_button.setIcon(FluentIcon.SETTING)
        # self.all_settings_button.setVisible(False)
        self.horizontalLayout.addWidget(self.all_settings_button)
...
class AccountsListToolsWidget(QWidget, Ui_Form):
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        delete_button_style = StyleSheet(
            f"{os.environ['ACCOUNT_MANAGER_PATH_TO_RESOURCES']}/dark/delete_button.qss"
        )
        setCustomStyleSheet(
            self.delete_button, str(delete_button_style), str(delete_button_style)
        )

    def set_all_settings_button_visibility(self, visibility: bool) -> None:
        self.all_settings_button.setVisible(visibility)
        if visibility:
